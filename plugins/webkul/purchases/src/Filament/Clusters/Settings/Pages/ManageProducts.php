...
class ManageProducts extends SettingsPage
{
    ...
    {
        return [
            __('purchases::filament/clusters/settings/pages/manage-products.title'),
        ];
    }

    public function getTitle(): string
    {
        return __('purchases::filament/clusters/settings/pages/manage-products.title');
    }
