...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('accounts_account_moves', function (Blueprint $table) {
            ...
            $table->decimal('invoice_currency_rate')->nullable()->comment('Currency Rate');
            $table->decimal('amount_untaxed')->nullable()->comment('Untaxed Amount');
            $table->decimal('amount_tax')->nullable()->comment('Tax Amount');
            $table->decimal('amount_total')->nullable()->comment('Total Amount');
            $table->decimal('amount_residual')->nullable()->comment('Residual Amount');
            $table->decimal('amount_untaxed_signed')->nullable()->comment('Untaxed Amount Signed');
            $table->decimal('amount_untaxed_in_currency_signed')->nullable()->comment('Untaxed Amount in Currency Signed');
            $table->decimal('amount_tax_signed')->nullable()->comment('Tax Amount Signed');
            $table->decimal('amount_total_signed')->nullable()->comment('Total Amount Signed');
            $table->decimal('amount_total_in_currency_signed')->nullable()->comment('Total Amount in Currency Signed');
            $table->decimal('amount_residual_signed')->nullable()->comment('Residual Amount Signed');
            $table->decimal('quick_edit_total_amount')->nullable()->comment('Quick Edit Total Amount');
