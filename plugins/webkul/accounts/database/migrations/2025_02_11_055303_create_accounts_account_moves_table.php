...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('accounts_account_moves', function (Blueprint $table) {
            ...
            $table->decimal('invoice_currency_rate', 15, 2)->nullable()->comment('Currency Rate');
            $table->decimal('amount_untaxed', 15, 2)->nullable()->comment('Untaxed Amount');
            $table->decimal('amount_tax', 15, 2)->nullable()->comment('Tax Amount');
            $table->decimal('amount_total', 15, 2)->nullable()->comment('Total Amount');
            $table->decimal('amount_residual', 15, 2)->nullable()->comment('Residual Amount');
            $table->decimal('amount_untaxed_signed', 15, 2)->nullable()->comment('Untaxed Amount Signed');
            $table->decimal('amount_untaxed_in_currency_signed', 15, 2)->nullable()->comment('Untaxed Amount in Currency Signed');
            $table->decimal('amount_tax_signed', 15, 2)->nullable()->comment('Tax Amount Signed');
            $table->decimal('amount_total_signed', 15, 2)->nullable()->comment('Total Amount Signed');
            $table->decimal('amount_total_in_currency_signed', 15, 2)->nullable()->comment('Total Amount in Currency Signed');
            $table->decimal('amount_residual_signed', 15, 2)->nullable()->comment('Residual Amount Signed');
            $table->decimal('quick_edit_total_amount', 15, 2)->nullable()->comment('Quick Edit Total Amount');
